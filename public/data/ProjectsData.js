const ProjectsData = [
	...
	},
	{
		...
		banner_img: '/src/assets/spicy-mexican-chefs/fullscreen.png',
		screenshots: [
			'/src/assets/spicy-mexican-chefs/banner.png',
			'/src/assets/spicy-mexican-chefs/about.png',
			'/src/assets/spicy-mexican-chefs/chefs.png',
			'/src/assets/spicy-mexican-chefs/details.png',
			'/src/assets/spicy-mexican-chefs/footer.png',
			'/src/assets/spicy-mexican-chefs/recipes.png',
			'/src/assets/spicy-mexican-chefs/signin.png',
			'/src/assets/spicy-mexican-chefs/signup.png',
		],
	},
	{
		id: '3',
		...
		banner_img: '/src/assets/task-manager/fullscreen.png',
		screenshots: [
			'/src/assets/task-manager/banner.png',
			'/src/assets/task-manager/add.png',
			'/src/assets/task-manager/delete.png',
			'/src/assets/task-manager/update.png',
		],
	},
];
